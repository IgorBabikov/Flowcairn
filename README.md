<p align="center">
  <img src="docs/assets/flowcairn-banner.svg" alt="Flowcairn — AI пишет код. Вы видите всю работу." width="100%">
</p>

<p align="center">
  <a href="#быстрый-старт"><strong>Установить</strong></a> ·
  <a href="#первая-задача">Первая задача</a> ·
  <a href="docs/SKILLS.md">Ваши Skills</a> ·
...
# AI-разработка, за которой можно следить

**Flowcairn превращает задачу в граф работы AI:** анализ, план, одно согласование, изменения, проверки и ревью. Устанавливается рядом с существующим Git-проектом и показывает, что происходит, почему работа остановилась и чем подтвержден результат.

В длинной переписке сложно понять, какие требования учтены, что уже сделано и какие проверки действительно выполнены. Flowcairn собирает это в одном рабочем процессе.
...
| --- | --- |
| Понять план до изменения кода | Этапы, зависимости, разрешенные файлы и Skills |
...
| Сохранить правила команды | Существующие инструкции и выбранные project Skills |
...
2. **Первый запуск** предложит короткую настройку и откроет UI. Если есть свои Skills, выберите нужные.
...
> Добавь форму регистрации с email, паролем и подтверждением пароля. Для компании показывай название и ИНН. Объясняй ошибки рядом с полями, сохраняй введенные данные и блокируй повторную отправку. Используй правила проекта.
...
## Skills под ваш проект

- **Свои Skills есть:** выбираете их при настройке, указываете этапы и область. Файлы остаются на месте.
- **Своих Skills нет:** Flowcairn использует встроенные рекомендации по анализу, реализации, проверкам и ревью.
- **Разные части проекта:** frontend, backend и mobile получают подходящие рекомендации по распознанным манифестам. Неизвестный стек остается общим инженерным проектом.
- **Тесты:** существующие checks выполняются по профилю. Новые тесты добавляются по задаче и правилам команды; процент покрытия не навязывается.

[Какие Skills входят в пакет и как выбираются →](docs/SKILLS.md)
...
| [Skills и правила проекта](docs/SKILLS.md) | [Проверки и их границы](docs/VERIFICATION.md) |
