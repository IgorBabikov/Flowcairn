...
<p align="center">
  ...
  <a href="https://github.com/IgorBabikov/flowcairn/releases"><img src="https://img.shields.io/github/downloads/IgorBabikov/flowcairn/total?label=Скачивания%20архивов&amp;color=397b5b" alt="Скачивания файлов GitHub Releases за все время"></a>
...
> [!NOTE]
> Кандидат 0.2.0 пока не опубликован в npm. Команды выше описывают целевой запуск после публикации. До нее доступна [проверка готового архива](docs/INSTALLATION.md#проверить-еще-не-опубликованный-пакет). Публикация требует авторизации владельца в npm.
