...
function physicalDirectory(directory, code, { privateMode = false } = {}) {
  let stat;
  try {
...
function privateGraphDirectory(root) {
...
function stopProofPath(root, metadata, { create = false } = {}) {
  const graph = create
...
function terminalEvidence(inspected, waited) {
