...
При конфликте workflow с проектными правилами покажи точное противоречие и получи явное решение. Не переписывай правила молча. Обнаружение Skill или plugin не разрешает запуск его скриптов.
